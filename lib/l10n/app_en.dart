...
Map<String, String> get en => {
  ...
  'exportForCurrentMonth': 'Export for Current Month',
  'exportForCustomRange': 'Export with Custom Range',
  ...
  // Storage permission translations
  'storagePermission': 'Storage Permission',
  'storagePermissionReason': 'We need storage permission to save the exported CSV file to your Downloads folder. This makes it easier to find and share your financial data.',
  'storagePermissionDenied': 'Storage permission denied. Cannot save file to Downloads.',
